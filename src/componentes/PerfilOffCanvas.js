            ...
            <div className="row">
             ...
             <div className="row">
                    ...
                    <button className="btn btn-secondary rounded__btn">
                        <NavLink to="/" className="nav-link" aria-current="page" onClick={cerrarSesion()}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" width="23" height="23" className="bi bi-box-arrow-right" viewBox="0 0 16 16">
